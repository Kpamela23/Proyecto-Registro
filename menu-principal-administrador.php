                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Llenar el siguiente Formulario</h5>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-primary" id="btn-agregar-alumno">Adicionar</button>
                            </div>
                          </div>
                        </div>
                      </div>
